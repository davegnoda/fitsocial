...
const navItems = [
  { path: '/dashboard', icon: (active: boolean) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? '#FF4500' : '#8A8A96'}>
          ...
          >
            <div
              ...
              style={{
                ...
                border: active ? '1px solid rgba(255,69,0,0.25)' : '1px solid transparent',
              }}
            >
              {item.icon(active)}
            </div>
            <span
              ...
              style={{ color: active ? '#FF4500' : '#8A8A96' }}
            >
              {item.label}
            </span>
          </Link>
